...
if DUNGEON_DATA_WII:
    DUNGEONS = [
        ("Test Dungeon", DIR_UP),
        ("Dubious Woods", DIR_UP),
        ("Cheery Field", DIR_UP),
        ("Sunset Crag", DIR_DOWN),
        ("Chocolate Cliffs", DIR_UP),
        ("Path to Treasure Valley", DIR_DOWN),
        ("Wildfire Highland", DIR_UP),
        ("Ruby Lakeside", DIR_DOWN),
        ("Rippling Seas", DIR_DOWN),
        ("Enigmatic Plains", DIR_UP),
        ("Bizarre Bluff", DIR_UP),
        ("Secret Islands", DIR_UP),
        ("Unown Village", DIR_UP),
        ("Unknown dungeon", DIR_UP),
        ("Marsh Valley", DIR_DOWN),
        ("Unknown dungeon", DIR_UP),
        ("Unknown dungeon", DIR_UP),
        ("Unknown dungeon", DIR_UP),
        ("Unknown dungeon", DIR_UP),
        ("Unknown dungeon", DIR_UP),
        ("Secret Training Grounds", DIR_UP),
        ("Unknown dungeon", DIR_UP),
        ("Unknown dungeon", DIR_UP),
        ("Unknown dungeon", DIR_UP),
        ("Unknown dungeon", DIR_UP),
        ...
        ("Unknown dungeon", DIR_UP),
        ("Unknown dungeon", DIR_UP),
        ("Mythic Magma Isle", DIR_UP),
        ("Unknown dungeon", DIR_UP),
        ("Final Sacred Peak", DIR_UP),
        ("Unknown dungeon", DIR_UP),
        ("Dubious Hill", DIR_UP),
        ("Lively Field", DIR_UP),
        ("Cloudy Crag", DIR_DOWN),
        ("Chocolate Isles", DIR_UP),
        ("Path to Treasure Mountain", DIR_DOWN),
        ("Tempest Island", DIR_DOWN),
        ("Jade Lakeside", DIR_DOWN),
        ("Storming Seas", DIR_UP),
        ("Enigmatic Swamp", DIR_UP),
        ("Bizarre Rockland", DIR_UP),
        ("Secret Plateau", DIR_UP),
        ("Unown Resort", DIR_UP),
        ("Unknown dungeon", DIR_UP),
        ("Stream Forest", DIR_DOWN),
        ("Unknown dungeon", DIR_UP),
        ("Unknown dungeon", DIR_UP),
        ("Unknown dungeon", DIR_UP),
        ("Unknown dungeon", DIR_UP),
        ...
        ("Unknown dungeon", DIR_UP),
        ("Unknown dungeon", DIR_UP),
        ("Mythic Quagmire", DIR_UP),
        ("Unknown dungeon", DIR_UP),
        ("Final Lone Island", DIR_UP),
        ("Unknown dungeon", DIR_UP),
        ("Dubious Valley", DIR_UP),
        ("Sparkling Field", DIR_UP),
        ("Shady Crag", DIR_DOWN),
        ("Chocolate Plains", DIR_UP),
        ("Path to Treasure Island", DIR_DOWN),
        ("Radiant Summit", DIR_UP),
        ("Mica Lakeside", DIR_DOWN),
        ("Wavy Seas", DIR_UP),
        ("Enigmatic Meadow", DIR_UP),
        ("Bizarre Grove", DIR_UP),
        ("Secret Rock Ridge", DIR_UP),
        ("Unown Garden", DIR_UP),
        ("Unknown dungeon", DIR_UP),
        ("Frozen Mound", DIR_DOWN),
        ("Unknown dungeon", DIR_UP),
        ("Unknown dungeon", DIR_UP),
        ("Unknown dungeon", DIR_UP),
        ("Unknown dungeon", DIR_UP),
        ...
        ("Unknown dungeon", DIR_UP),
        ("Unknown dungeon", DIR_UP),
        ("Unknown dungeon", DIR_DOWN),
        ("Unknown dungeon", DIR_UP),
        ("Mythic Mountain", DIR_UP),
        ("Unknown dungeon", DIR_UP),
        ("Final Cavern", DIR_UP),
    ]
    for did, dinfo in enumerate(DUNGEONS):
